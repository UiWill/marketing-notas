...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black">
      ...
      {/* Video Section */}
      <section data-section-id="video" className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <VideoPlayer
            url="https://youtu.be/vmmBD2Rxb9M"
            leadId={leadId}
            sessionId={pageViewId || undefined}
      ...
      {showContent && (
        <>
          ...
          <section data-section-id="testimonials" className="bg-white py-16">
          ...
          <section data-section-id="benefits" className="bg-gradient-to-br from-purple-900 via-blue-900 to-purple-900 py-16 px-4">
            <div className="max-w-4xl mx-auto">
          ...
          <section data-section-id="comparison" className="bg-gradient-to-br from-purple-900 via-blue-900 to-purple-900 py-16 px-4">
            <div className="max-w-6xl mx-auto">
              <ScrollAnimation animation="slideUp">
          ...
          <section data-section-id="pricing" className="bg-gradient-to-br from-purple-900 via-blue-900 to-purple-900 py-16 px-4">
            <div className="max-w-4xl mx-auto">
          ...
          <section data-section-id="guarantee" className="bg-white py-16 px-4">
            <div className="max-w-4xl mx-auto text-center">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
